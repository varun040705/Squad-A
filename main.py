...
from squad_h.aggregate_engine import run_ae_engine_from_aggregate_csv

aggregate_context = run_ae_engine_from_aggregate_csv(
    inspection_id="AE-CSV-001",
    element_ref="BRIDGE-DT-01",
    csv_path="datasets/bridge_digital_twin_dataset.csv",
    window_size_seconds=86400,
)

print("\nAGGREGATE-INPUT AE CONTEXT (real dataset)")
print("------------------------------------------")
print(aggregate_context)
